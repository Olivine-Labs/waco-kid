...
_Bool str_array_is_full(const str_array * l);
_Bool str_array_resize(str_array *l, int new_cap);
_Bool str_array_append(str_array * list, char * token);
...
_Bool r3_node_has_slug_edges(const node *n);
